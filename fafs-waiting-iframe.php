...
// Original parent element access with error checking
try {
    var el = window.parent.parent.document.getElementById('callData');
    if (el) {
        el.style.display = "none";	
        el.innerHTML='';
        console.log('callData element hidden successfully');
    } else {
        console.warn('callData element not found in parent');
    }
} catch (error) {
    console.error('Error accessing callData element:', error);
}
...
try {
    ...
    if (pr) {
        pr.disabled = false;
        console.log('presence element enabled successfully');
    } else {
        console.warn('presence element not found in parent');
    }
} catch (error) {
    console.error('Error accessing presence element:', error);
}
...
try {
    ...
    if (acdsel) {
        ...
        console.log('ifCall element hidden successfully');
    } else {
        console.warn('ifCall element not found in parent');
    }
} catch (error) {
    console.error('Error accessing ifCall element:', error);
}

// Function to safely handle No Form Pop button click
function handleNoFormPop() {
    ...
    try {
        ...
        if (ifwfc) {
            ...
            alert('Error: ifwfc element not found. Please check if the parent page is loaded correctly.');
        }
    } catch (error) {
        console.error('Error in handleNoFormPop:', error);
...
<button onclick="handleNoFormPop();">No Form Pop</button>
IFSBTN;
